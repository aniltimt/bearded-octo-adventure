...
describe "crm/financial_infos/edit" do
  before(:each) do
  ...
  it "renders the edit crm_financial_info form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => crm_financial_infos_path(@crm_financial_info), :method => "post" do
